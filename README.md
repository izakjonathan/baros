...
**Current release: v0.12.1 — Cohesive Product Design**
...
Use `DATABASE_URL` for the pooled Neon runtime connection and `DATABASE_DIRECT_URL` for migrations. v0.12.1 includes migration `011_daily_operations.sql`.
