...
**Current release: v0.11.8 — Unified Typography System**
...
Use `DATABASE_URL` for the pooled Neon runtime connection and `DATABASE_DIRECT_URL` for migrations. v0.11.8 adds migration `011_daily_operations.sql`.
