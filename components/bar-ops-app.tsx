...
function Team({ employees, shifts, devMode, onAdd, onEdit, onInvite, onRevoke }: { employees: Employee[]; shifts: Shift[]; devMode:boolean; onAdd: () => void; onEdit: (employee: Employee) => void; onInvite:(employee:Employee)=>void; onRevoke:(employee:Employee)=>void }) {
  ...
  return <div className={teamStyles.workspace}>
    <PageHeader eyebrow="People operations" title="Team" subtitle="Employees, access and upcoming scheduled hours in one workspace." action={<button className={`team-add-button ${teamStyles.addButton}`} onClick={onAdd}><UserRoundPlus size={17}/>Add employee</button>}/>
