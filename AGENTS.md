...
- CSS architecture: shared visual rules are global. Shift Plan is the only original feature with custom CSS; the standalone Operation module is an explicit custom-design exception.
