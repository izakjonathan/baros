...
const checks=[
  [["0.10.5","0.10.6","0.11.0","0.11.1","0.11.2","0.11.3","0.11.4"].includes(pkg.version),"package version"],
  [/v0\.(?:10\.[56]|11\.[0-4])/.test(read("README.md")),"current README"],
  [/^# Implementation status — v0\.(?:10|11)\./.test(read("IMPLEMENTATION_STATUS.md")),"current implementation status"],
  [/bar-ops-v(?:010[56]|0110|0111|0112|0113|0114)/.test(read("public/sw.js")),"rotated service-worker cache"],
