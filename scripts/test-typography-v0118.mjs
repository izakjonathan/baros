...
if(!['0.11.8','0.11.9','0.12.0','0.12.1','0.12.2'].includes(pkg.version)) throw new Error('Expected v0.11.8');
...
if(!system.includes('v0.12.2 — canonical product presentation layer')) throw new Error('Missing typography layer');
