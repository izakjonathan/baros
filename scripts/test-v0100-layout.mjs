...
const checks=[
 ['version',['0.10.0','0.10.1','0.10.2','0.10.3','0.10.4','0.10.5','0.10.6','0.11.0','0.11.1','0.11.2','0.11.3','0.11.4','0.11.6','0.11.8','0.11.9','0.12.0','0.12.1'].includes(pkg.version)],
 ...
 ['compact team cards',/\.team-card\s*\{[^}]*padding:\s*(?:var\(--space-card\)|1[4-6]px)/.test(css)],
];
