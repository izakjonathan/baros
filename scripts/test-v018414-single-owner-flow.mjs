...
const fail=(m)=>{console.error(`v0.18.4.14 regression: ${m}`);process.exit(1)};
if(pkg.version!=="0.18.4.14") fail("package version mismatch");
...
console.log("v0.18.4.14 single-owner page-flow regression passed");
