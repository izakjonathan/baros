...
if (pkg.version !== "0.18.15") failures.push("package version is not v0.18.15");
...
if (!readme.includes("Current release: **v0.18.15**")) failures.push("README current release is not v0.18.15");
...
if (!release.includes("v0.18.15")) failures.push("release notes do not identify v0.18.15");
...
console.log("v0.18.15 production-readiness regression passed");
