...
const monoComponents=fs.readFileSync("app/mono-components.css","utf8");
...
for (const [name,css] of [["employee",employee],["attendance",attendance],["requests",requests],["mono-components",monoComponents]]) {
