...
const checks=[
 ...
 ['release version',['0.12.2','0.12.3','0.12.4','0.13.0','0.13.1','0.13.2','0.13.3','0.13.4','0.14.0','0.14.1','0.14.2','0.14.3','0.14.4','0.15.0'].includes(JSON.parse(fs.readFileSync('package.json','utf8')).version)],
];
