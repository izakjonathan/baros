...
const checks=[
  [["0.10.6","0.11.0","0.11.1","0.11.2","0.11.3","0.11.4","0.11.6","0.11.8"].includes(pkg.version),"package version"],
  ...
  [system.startsWith("/* Bar Ops design-system components"),"valid design-system header"],
