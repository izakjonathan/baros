...
const css=fs.readFileSync('app/globals.css','utf8')+fs.readFileSync('app/product-system.css','utf8')+fs.readFileSync('app/interface-v014.css','utf8');
const pkg=JSON.parse(fs.readFileSync('package.json','utf8'));
const checks=[
  [['0.9.6','0.9.7','0.9.8','0.9.9','0.10.0','0.10.1','0.10.2','0.10.3','0.10.4','0.10.5','0.10.6','0.11.0','0.11.1','0.11.2','0.11.3','0.11.4','0.11.6','0.11.8','0.11.9','0.12.0','0.12.1','0.13.0','0.13.1','0.13.2','0.14.0'].includes(pkg.version),'package version is compatible'],
