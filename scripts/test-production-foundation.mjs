...
for(const phrase of ['draggable','Control centre','Payroll ID','salaryCode','costCentre','/api/manager/bootstrap']) if(!component.includes(phrase)) throw new Error(`Missing UI integration: ${phrase}`);
