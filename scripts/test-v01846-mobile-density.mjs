...
if(pkg.version!=="0.18.4.6") fail("package version mismatch");
...
if(!shell.includes("width:2.75rem")||!shell.includes("min-height:3.75rem")) fail("compact topbar dimensions missing");
