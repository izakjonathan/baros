...
const checks=[
 ['version',['0.9.7','0.9.8','0.9.9','0.10.0','0.10.1','0.10.2','0.10.3','0.10.4','0.10.5','0.10.6','0.11.0','0.11.1','0.11.2','0.11.3','0.11.4','0.11.6','0.11.8','0.11.9','0.12.0','0.12.1'].includes(pkg.version)],
 ...
 ['transparent icon buttons',/\.icon-button[\s\S]*background\s*:\s*transparent/.test(css) && /\.floating-navigation-toggle[\s\S]*background\s*:\s*#111/.test(css)],
