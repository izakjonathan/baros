...
const checks = [
  ...
  ["Operation owner editor opens a full-screen notes-style block editor", operationModule.includes("type DraftArticle = { id?: string; kind: OperationArticleKind; category: string; title: string; description: string; content: OperationContentBlock[] }") && operationModule.includes("function ArticleEditor") && operationModule.includes("function EditorBlock") && operationModule.includes("setEditorOpen(true)") && operationModule.includes("Add at least one content block before saving.") && operation.includes(".articleEditor{position:fixed;inset:0") && operation.includes(".notesToolbar{position:fixed") && operation.includes(".notesEditor{") && operation.includes(".editorBlock{")],
