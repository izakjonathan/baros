...
assert(actions.includes('className="portal-action shift-card-action"'), "handover trigger must use compact card action class");
...
assert(actions.includes('primary-action shift-card-action'), "request-shift trigger must use compact card action class");
