...
const components=read('app/product-system.css');
const layout=read('app/layout.tsx');
const pkg=JSON.parse(read('package.json'));
const checks=[
 ['version 0.9.9+',['0.9.9','0.10.0','0.10.1','0.10.2','0.10.3','0.10.4','0.10.5','0.10.6','0.11.0','0.11.1','0.11.2','0.11.3','0.11.4','0.11.6','0.11.8','0.11.9','0.12.0','0.12.1','0.13.0','0.13.1','0.13.2','0.14.0'].includes(pkg.version)],
 ['mono tokens loaded',layout.includes('design-tokens.css')],
 ['mono components loaded',layout.includes('product-system.css')],
