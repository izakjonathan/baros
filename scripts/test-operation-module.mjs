...
const checks = [
  ...
  ["Legacy article lists are grouped into one list", operation.includes("function RichTextArticle") && operation.includes("while (index < lines.length && lines[index].attributes?.list === list)") && operationStyles.includes(".readerArticle ul,.readerArticle ol{display:grid;gap:.18rem")],
