...
const checks = [
  ...
  ["Today news exposes full readable updates in the page flow", operation.includes("function NewsFeed") && operation.includes("showBody") && operation.includes("function articleCardBody") && !operation.includes("news.slice(0, 3)") && operationStyles.includes(".newsCard .articleCardOpen p{")],
