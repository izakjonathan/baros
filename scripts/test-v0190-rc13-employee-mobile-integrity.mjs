...
assert.match(consistency,/\.search-popover \{[\s\S]*?max-height: min\(24rem, 46dvh\);[\s\S]*?overflow: hidden;/);
assert.match(consistency,/\.search-popover > div:last-child \{[\s\S]*?overflow-y: auto;/);
