...
const checks=[
 ['version',/^0\.10\.(?:2|3|4|5|6)$/.test(pkg.version) || ['0.11.0','0.11.1','0.11.2','0.11.3','0.11.4','0.11.6','0.11.8','0.11.9','0.12.0','0.12.1','0.13.0','0.13.1','0.13.2'].includes(pkg.version)],
