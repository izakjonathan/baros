...
const fail=(message)=>{console.error(`v0.18.4.16 regression: ${message}`);process.exit(1)};
if(pkg.version!=="0.18.4.16") fail("package version mismatch");
...
if(!css.includes("v0.18.4.16 shift-plan simplification")) fail("shift-plan simplification CSS missing");
...
console.log("v0.18.4.16 shift-plan simplification regression passed");
