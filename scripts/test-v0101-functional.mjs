...
const app=fs.readFileSync('components/bar-ops-app.tsx','utf8')+fs.readFileSync('components/app-shell.tsx','utf8');
const timesheets=fs.readFileSync('app/api/timesheets/route.ts','utf8');
const pkg=JSON.parse(fs.readFileSync('package.json','utf8'));
const checks=[
 ['version',['0.10.1','0.10.2','0.10.3','0.10.4','0.10.5','0.10.6','0.11.0','0.11.1','0.11.2','0.11.3','0.11.4','0.11.6','0.11.8','0.11.9','0.12.0','0.12.1','0.13.0','0.13.1','0.13.2','0.14.0'].includes(pkg.version)],
 ...
 ['navigation close labelled',app.includes('Close navigation')&&app.includes('aria-expanded={open}')],
